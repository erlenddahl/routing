copy "D:\Nextcloud\Mine program\C#\Extensions\ByteUtilities\bin\Release\ByteUtilities.dll" .
copy "D:\Nextcloud\Mine program\C#\Extensions\ConsoleUtilities\bin\Release\ConsoleUtilities.dll" .
