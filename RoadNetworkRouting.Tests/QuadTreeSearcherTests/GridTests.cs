...
namespace RoadNetworkRouting.Tests.QuadTreeSearcherTests
{
    ...
    public class GridTests
    {
        ...
        public void MultipleItemsWithinSingleCell()
        {
            ...
            Assert.AreEqual(2, cache.GetNearbyItems(55, 55).Count());

            // Hits the third
            Assert.AreEqual(1, cache.GetNearbyItems(68, 66).Count());
        }
        ...
        public void SingleItemOverlappingTwoCells()
        {
            ...
            Assert.AreEqual(0, cache.GetNearbyItems(55, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(105, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(155, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(5, 55).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(155, 55).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(5, 105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(55, 105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(105, 105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(155, 105).Count());

            // Check that there is a single item in the two middle cells
            Assert.AreEqual(1, cache.GetNearbyItems(59, 60).Count());
            Assert.AreEqual(1, cache.GetNearbyItems(105, 70).Count());

            // But only if actually inside the item area
            Assert.AreEqual(0, cache.GetNearbyItems(55, 65).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(105, 55).Count());
        }
        ...
        public void SingleItemOverlappingTwoCellsAroundOrigin()
        {
            ...
            // Check that there are no items in the cells surrounding this item.
            Assert.AreEqual(0, cache.GetNearbyItems(-95, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(-45, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(5, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(55, 5).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(105, 5).Count());
                                                   
            Assert.AreEqual(0, cache.GetNearbyItems(-95, 55).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(55, 55).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(105, 55).Count());
                                                   
            Assert.AreEqual(0, cache.GetNearbyItems(-95,105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(-45, 105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(5, 105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(55, 105).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(105, 105).Count());

            // Check that there is a single item in the two center cells
            Assert.AreEqual(1, cache.GetNearbyItems(-35, 65).Count());
            Assert.AreEqual(1, cache.GetNearbyItems(5, 65).Count());

            // But only if actually inside the item area
            Assert.AreEqual(0, cache.GetNearbyItems(-45, 55).Count());
            Assert.AreEqual(0, cache.GetNearbyItems(5, 55).Count());
        }
    }
}
