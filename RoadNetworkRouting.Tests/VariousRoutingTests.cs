    ...
    public void CuttingWhenOverloaderChangesOneOfTheLinks_SeparateGroups()
    {
        var links = new[]
        {
            new RoadLink()
            {
                ...
                LaneCode = "",
                Cost = 3.6848573684692383f,
                ReverseCost = 3.6848573684692383f,
                NetworkGroup = 1
            },
            new RoadLink()
            {
                ...
                LaneCode = "",
                Cost = 11.07801628112793f,
                ReverseCost = 11.07801628112793f,
                NetworkGroup = 2
            },
            new RoadLink()
            {
                ...
                LaneCode = "",
                Cost = 0.7758787870407104f,
                ReverseCost = 0.7758787870407104f,
                NetworkGroup = 2
            }
        };
